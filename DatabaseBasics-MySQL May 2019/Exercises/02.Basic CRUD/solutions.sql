...
SELECT concat_ws(' ',first_name,IFNULL(NULL, `middle_name`), last_name) AS full_name,job_title FROM employees;
...
-- Solution with nested query (doesn't pass tests in Judge!)
UPDATE employees
SET salary=salary*1.12
WHERE department_id IN (
	SELECT d.department_id
	FROM departments d
	WHERE d.name IN ('Engineering' , 'Tool Design','Marketing',
